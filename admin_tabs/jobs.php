    ...
    <table>
        ...
        foreach ($jobs_list as $job): ?>
            <tr>
                ...
                <td>
                    <div class="action-flex" style="gap: 12px; flex-wrap: wrap;">
                        ...
                        <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
                            <a href="admin.php?tab=manage_exam&job_id=<?= $job['id'] ?>" class="btn-icon" style="background:var(--blue); color:#fff; display:flex; align-items:center; justify-content:center; text-decoration:none;" title="Manage Exam">
                                <i class="fa-solid fa-clipboard-list"></i>
                            </a>
                            <span
                                style="font-size: 9px; font-weight: 700; color: #64748b; text-transform: uppercase;">Exam</span>
                        </div>
                        <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
