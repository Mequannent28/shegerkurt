        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div
                ...
                <div
                    ...
                    <?php
                    $fallback = 'https://ui-avatars.com/api/?name=' . urlencode($_SESSION['admin_name']) . '&background=ff9d2d&color=fff';
                    $current_pic = !empty($_SESSION['admin_pic']) ? htmlspecialchars($_SESSION['admin_pic']) : $fallback;
                    ?>
