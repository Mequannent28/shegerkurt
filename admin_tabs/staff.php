...
<div class="modal-overlay" id="idCardModal" style="display: none;">
    <style>
        ...
        .staff-id-header {
            background: linear-gradient(135deg, var(--rich-black-fogra-29, #0f172a), #1e293b);
            padding: 30px 20px 50px 20px;
            text-align: center;
            color: #fff;
            position: relative;
        }
        .staff-id-header::after {
            content: '';
            position: absolute;
            bottom: -20px;
            left: 0;
        ...
        @media print {
            ...
            #idCardModal { position: absolute; left: 0; top: 0; background: transparent; display:flex !important; align-items:flex-start; justify-content:flex-start; padding:0; }
            .no-print { display: none !important; }
            .staff-id-badge { box-shadow: none; border: 1px solid #ccc; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        }
    </style>
    
    <div style="background:transparent; display:flex; flex-direction:column; gap:20px; align-items:center;">
        <div class="staff-id-badge" id="printable_id_card">
            <div class="staff-id-header">
                <h3 class="staff-id-brand">SHEGER KURT</h3>
                <div class="staff-id-subbrand">Official Staff Badge</div>
            </div>
            
            <div class="staff-id-body">
                <div class="staff-avatar-wrapper">
                    <img src="" id="id_card_img" alt="Staff Photo">
                </div>
                
                <h2 class="staff-name" id="id_card_name">John Doe</h2>
                <div class="staff-role" id="id_card_role">Waitstaff</div>
                
                <div class="staff-details">
                    <div class="staff-detail-row">
                        <span class="staff-detail-label">EMP ID No:</span>
                        <span class="staff-detail-value" id="id_card_no">SK-000</span>
                    </div>
                    <div class="staff-detail-row">
                        <span class="staff-detail-label">Issued:</span>
                        <span class="staff-detail-value" id="id_card_dob"><?= date('Y/m/d') ?></span>
                    </div>
                    <div class="staff-detail-row">
                        <span class="staff-detail-label">Contact:</span>
                        <span class="staff-detail-value" id="id_card_phone">+251 000 000</span>
                    </div>
                </div>
                
                <div class="staff-qr-section">
                    <div class="staff-qr-info">
                        <div style="color:#1e293b; font-size:12px; margin-bottom:2px;">AUTHORIZED</div>
                        PROPERTY OF SHEGER KURT
                    </div>
                    <div class="staff-qr-box">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=ShegerKurtStaff" id="id_card_qr" style="width:100%; height:100%;">
                    </div>
                </div>
            </div>
        </div>
        
        <div style="background: #fff; padding: 20px; border-radius: 15px; width: 320px; box-shadow: 0 10px 25px rgba(0,0,0,0.1);" class="no-print">
            <button onclick="window.print()" class="btn" style="width:100%; background: var(--deep-saffron, #f59e0b); color: #fff; font-weight: 700; height: 50px; border-radius: 12px; border:none; margin-bottom:10px;">
                <i class="fa-solid fa-print"></i> Print High-Res Badge
            </button>
            <button onclick="closeModals()" class="btn" style="width:100%; background: #f1f5f9; color: #475569; font-weight: 700; height: 45px; border-radius: 12px; border:none;">
                Cancel
            </button>
        </div>
    </div>
